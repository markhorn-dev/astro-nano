...
<Highlight title="Uwaga">
  Pamiętaj, że labelki muszą być wcześniej dodane w repozytorium, aby można było je dodać do PRa. Możesz to zrobić ręcznie albo na początku skryptu sprawdzić i ewentualnie dodać je poprzez CLI. Jeśli pracujesz nad rozwiązaniem dla wielu projektów, to automatyczne dodawanie będzie bardzo pomocne w ich wdrażaniu.
</Highlight>
...
<Highlight title="Uwaga">
  Pamiętaj, żeby dopisać `labels` do argumentu polecenia pobierającego dane o PRze!
</Highlight>
